...
const InfiniteScrollPageIntersectionObserver = () => {
  ...
  const fetchData = async () => {
    try {
      ...
      setTimeout(() => {
        setData((prev) => {
          const updated = [...prev, ...Array(6).fill("data")];
  ...
  useEffect(() => {
    const observer = new IntersectionObserver(
      (entries) => {
        console.log("Onserver entries :", entries);
...
export default InfiniteScrollPageIntersectionObserver;
